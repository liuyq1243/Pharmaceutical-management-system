    ...
    : QDialog(parent)
{
    ...
    layout->addWidget(specLabel,3,0);
    layout->addWidget(medSpecEdit,3,1);
    layout->addWidget(supplierLabel,4,0);
    layout->addWidget(supplierEdit,4,1);
    ...
    layout->addWidget(addButton,7,1);
